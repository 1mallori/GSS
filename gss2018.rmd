...
$H_0$: Opinion on capital punishment is independant of gun ownership.

$H_a: opinion on OWNGUN and CAPPUN
...
This graph shows that people who own a gun are more likely to favor punishment
...
The Chi-squared test p-value is 0.0202, Hence we reject the null hypothesis and conclude that gun ownership capital punishment are not independent. 

The fisherexact test has a p-value of 0.01651 hence we reject the null hypothesis as with the chi-square test, and furthermore the odds ratio says that gun owners are 2.3 times more likely to favor capital punishment than those who don't own a gun. 
...
#### Question 1: is gun ownership independent of opinion on capital puishment.
